...
class ProductRoutes {
    ...
    initRoutes() {
        ...
        this.router.patch(
            ...
            [   check ("model").isString().notEmpty(),
                check("quantity").isNumeric().isInt({ gt: 0 }),
                check("changeDate").isString().optional({ nullable: true})
            ],
            this.errorHandler.validateRequest,
        ...
        this.router.patch(
            ...
            [   check ("model").isString().notEmpty(),
                check("quantity").isNumeric().isInt({ gt: 0 }),
                check("sellingDate").isString().optional({ nullable: true })
            ],
            this.errorHandler.validateRequest,
        ...
        this.router.get(
            ...
            [   check ("grouping").isString().optional(),
                check("category").isString().optional(),
                check("model").isString().optional()
            ],
